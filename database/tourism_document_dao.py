# database/tourism_document_dao.py
"""
...
Sử dụng database: du_lich_bai_chay
"""
...
class TourismDocumentDAO:
    """Milvus manager cho tourism document collections trong database du_lich_bai_chay"""
